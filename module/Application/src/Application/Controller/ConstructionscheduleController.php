...
class ConstructionscheduleController extends AbstractActionController
{
    public function indexAction()
    {
		...
		try{
	        ...
	        //$VTs->debug($_SESSION);
			if(!empty($_SESSION)){
				$pagePath = dirname(__DIR__) . "\\..\\..\\..\\..\\public\\include\\pageSetting\\constructionSchedule\\index.html";
